...
<div jepane="top" class="je-admin-top">
    ...
    <div class="je-admin-navs je-fl">
        <ul class="je-ovh je-dib" id="myTabNav">
           <shiro:hasRole name="admin"> <li class="curr"><a href="javascript:;" data-tab="p6" data-text="词汇管理" data-url="addEnglishWords.jsp" addtab><em><img src="images/setico.png"></em><p>词汇管理</p></a></li></shiro:hasRole>
            <li><a href="javascript:;" data-tab="p7" data-text="单项填空管理" data-url="englishExercisesList.jsp" addtab><em><img src="images/actico.png"></em><p>单项填空管理</p></a></li>
